 ...
 * @author rai
 */
public class PetugasListPengunjungFrame extends javax.swing.JFrame {

    /**
     * Creates new form PetugasMainFrame
     */
    public PetugasListPengunjungFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PetugasListPengunjungFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PetugasListPengunjungFrame().setVisible(true);
            }
        });
    }
