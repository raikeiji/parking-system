 ...
 * @author rai
 */
public class DaftarMemberForm extends javax.swing.JFrame {

    /**
     * Creates new form DaftarMemberForm
     */
    public DaftarMemberForm() {
        initComponents();
    }
...
//                System.out.println("Hapus Data Member Gagal, data tidak ditemukan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarMemberForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DaftarMemberForm().setVisible(true);
            }
        });
    }
