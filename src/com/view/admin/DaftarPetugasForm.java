 ...
 * @author rai
 */
public class DaftarPetugasForm extends javax.swing.JFrame {

    /**
     * Creates new form DaftarMemberForm
     */
    public DaftarPetugasForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarPetugasForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DaftarPetugasForm().setVisible(true);
            }
        });
    }
